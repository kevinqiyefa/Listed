...
//echo 'Message from Controller: You are in the controller home, using the method index()';
// load views. within the views we can echo out $songs and $amount_of_songs easily
        //$users_model = $this->loadModel('LoginModel');
    ...
    public function checklogin() {
        $users_model = $this->loadModel('UsersModel');
        return $users_model->verifyPassword($_POST['email'], $_POST['password']);
    }
...
// return views to index
    ...
    public function deleteMessage() {
        if (isset($_POST["submit_delete_message"]) && $_POST["message_id"] != "" ) {
...
//$messages_model->deleteMessageById($_POST["message_id"]);
        ...
        header('location: ' . URL . 'users/messagedeleted');
            ...
            header('location: ' . URL . 'users/viewMessage');
        }
