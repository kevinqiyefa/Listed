            ...
            <form action="<?php echo URL; ?>listings/createpropertyimages" method="POST" enctype="multipart/form-data">
                ...
                <div class="panel-footer clearfix">
                    <div class="pull-right">  
                        <button class="btn btn-lg btn-warning active" type="submit" name="submit_create_image" >Add Next Photo </button>
                        <button class="btn btn-lg btn-success active" type="submit" name="submit_done" href="<?php echo URL . "listings/listingcomplete" ?>">Done </button>
                    </div>    
                </div>
