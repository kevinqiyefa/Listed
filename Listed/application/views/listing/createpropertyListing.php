        ...
        <div class="panel panel-primary" >
            ...
            <form action="<?php echo URL; ?>listings/createpropertyListing" method="POST">
                ...
                <div class="panel-body"> 
                    ...
                    <div class="form-group col-lg-5">  
                        <label for="Inputschool_district">School District:</label><br>
                        <input type="radio" name="school_district" value="Yes" checked> Yes
                        <input type="radio" name="school_district" value="No"checked> No<br><br>
                        <!--<input type="hidden" name="school_district" id="1" value="1" > -->
                    </div>
                    <div class="form-group col-lg-1"></div>

                    <div class="form-group col-lg-5">
                        <label for="Inputdate_built">Year Built: </label>
                        <input type="number" min="1900" max="2016" class="form-control" name="date_built" placeholder="Year Built" required="" data-validation="length" data-validation-length="min4">
