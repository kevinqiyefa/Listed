...
<body>
    ...
    if (isset($_POST['login'])) {
        if (isset($_POST['email']) && isset($_POST['password'])&& users::checklogin()) {
        ...
        <div class="container-fluid">
            ...
            <div class="navbar-header" id="header-brand">
                ...
                <a class="navbar-brand" href="<?php echo URL . "home/" ?>">
                    <img alt="Brand" src="<?php echo URL . "public/img/logo.jpg" ?>" >
                </a>
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-left ">
                    <li><!--class="active"--><a href="<?php echo URL . "listings/" ?>">Homes</a></li>
                    
                                           
                        <li><a href="<?php echo URL . "sell/" ?>">Sell</a></li>
                        <li><a href="<?php echo URL . "realtors/" ?>">Realtors</a></li>
                    ...
                    if (isset($_SESSION['email']) && isset($_SESSION['password'])) {
                        ...
                        elseif (strpos($_SESSION['email'], 'vinqiyf@gmail') !== false) {
                            ?>
                            <li><a href="<?php echo URL . "users/" ?>">Current Users</a><br></li>
                            <?php
                        }
                        else {
                            ?>
                            <li><a href="<?php echo URL . "users/" ?>">User Profile</a><br></li>
                            <?php
                ...
                if ($home_check[1] != NULL && $home_check[1] != 'home/') {
                    ?>
            ...
            <div class="modal-content">
                ...
                <form action="<?php echo URL; ?>users/user_login" method="POST">
                    <div class="modal-body">
                        ...
                        <br>
                            <input type="checkbox" id="remember_me" name="remember_me" <?php //if(isset($_COOKIE['email'])){echo "checked='checked'"; } ?> value="1" />
